                                        ...
                                        <div class="tp-header__contact mr-30">
                                            <div class="tp-header__contact d-flex align-items-center">
                                                ...
                                                <div class="tp-header__icon-info ml-20">
                                                    <label>Email</label>
                                                    <span><a
                                                            href="maito:thepures@support.com">portxinfo@gmail.com</a></span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12 wow fadeInLeft   " data-wow-duration=".9s"
                        ...
                        <div class="tp-about__content">
                            <div class="about-section-title z-index  pb-50">
                                <div class="tp-section__subtitle tp-section__subtitle-before mb-15 p-relative">KNOW
                                    ABOUT PORTX
                                </div>
        ...
        <div class="container">
            ...
            <div class="row gx-0 ">
                ...
                <div class="tp-challenges__join-over text-center mt-70">
                    <p>Join over 3000 people who engage with sector. <button><a href="contact.html">Join
                                Now!</a></button>
                    </p>
                </div>
            </div>
                                ...
                                <div class="swiper-slide ">
                                    <div class="tp-testimonial__item p-relative fix">
                                        ...
                                        <div class="tp-testimonial__content pb-20">
                                            <p>Sed tincidunt augue et so lobortis lacus, nec feugiat massa gravida a.
                                                Aenean
                                                risus
                                                dolor, placerat teelementumMorbi lacus metus, pellentesque rat ornare
                                                duis</p>
                                        </div>
    ...
    <div class="blog-area pt-105 pb-85">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-8 col-xl-8 col-lg-9">
                    <div class="blog-section-title text-center z-index  pb-50">
                        <div class="tp-section__subtitle tp-section__subtitle-before mb-15 p-relative">Our News From
                            Blog
                        </div>
